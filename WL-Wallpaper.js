...
Module.register("WL-Wallpaper", {
                ...
                nextImg.onload = function () {
                    ...
                    setTimeout(() => {
                        if (self.config.crossfade) {
                            nextImg.ontransitionend = function () {
                                img.remove();
                            };
    ...
    getWallpaperClasses: function (image) {
        var self = this;
        var viewport = self.getViewport();
        var fitVerticalWidth =
            (image.naturalWidth * viewport.height) / image.naturalHeight;
